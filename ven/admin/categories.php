...
<div class="container-fluid">
  <div class="row">
    ...
    <?php include "./templates/sidebar3.php"; ?>
      ...
      <div class="row">
      	<div class="col-10">
      		<h2>Manage Categorie</h2>
      	</div>
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-primary btn-sm">Ajouter Category</a>
      	</div>
      </div>
      ...
      <div class="modal-body">
        <form id="add-category-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-category">Ajoutdr Categorie</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-category-btn">Mise à jour Categorie</button>
            </div>
          </div>

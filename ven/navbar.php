     ...
     <header id="header-bar">
        ...
        <div class="title-bar">
          <h4 class="livraison">LIEU DE LIVRAISON: <strong>EUR</strong></h4>
           <h2 class="Marybe"><a style="color:black;text-decoration:none;" href="index.php"> LoyaltyCard</a>
          </h2>
          <div class="icons">
            ...
            <?php if  ( $_SESSION['status'] != 1 || isset($_SESSION['company'])  AND isset($_SESSION['status'])   ){  ?>
               <a href="<?= isset($_SESSION['company']) && $_SESSION['company'] == 1 ? "account-company.php" : "../public/account.php";?>">
                 <i style="font-size:20px"class="fa"> &#xf013;</i></a> <?php } elseif ($_SESSION['status']==1    ) {?>
        ...
        <div>
            <ul class="nav-bar" id="nav-bar-hide">
                ...
                <li><a href='../public/add_en.php'>OFFRES</a></li>
        ...
        <div id="mySidepanel" class="sidepanel">
           ...
           <section>
            ...
            <div class="sign-nav">
                ...
                <button class="button-create" style="margin-top: 9px;" onclick="document.location.href='company-inscription.php'" >CRÉER UN COMPTE D'ENTREPRISE</button>
            </div>
            <?php endif; ?>
            <?php if (is_logged_in()) : ?>

              <p class="welcome"> Bienvenue <?php echo $_SESSION['full_name'] ; ?>
              <a class="log_out" href="<?php echo ('logout.php'); ?>">SE DECONNECTER</a>
    ...
    <section>
      <div class="sign-up" id="signup-container">
       ...
       <p class="rejoignez">Rejoignez-nous sur LoyaltyCard.fr</p>
            ...
            <form action="<?php echo('index.php?p=');echo($id_parrain); ?>" method="post">

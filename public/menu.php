...
<html id="html-id"  dir="ltr" lang="fr-FR">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../ven/css/menu.css">
        
        <link rel="shortcut icon" href="images/EWU.ico" type="image/x-icon" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <script src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async=""></script>
<link rel="stylesheet" type="text/css" href="../ven/style.css">

<link rel="stylesheet" href="../ven/css/bootstrap.min.css"/>
        <script src="../ven/js/jquery2.js"></script>
        <script src="../ven/js/bootstrap.min.js"></script>
     ...
     <header id="header-bar" >
        ...
        <div class="title-bar">
          <h4 class="livraison">LIEU DE LIVRAISON: <strong>EUR</strong></h4>
           <h2 class="Marybe"><a style="color:black;text-decoration:none;" href="../ven/index.php"> LoyaltyCard</a>
          </h2>
          <div class="icons">
            ...
            <?php if ( $_SESSION['status'] != 1 || isset($_SESSION['company'])){  ?>  <a href="<?= isset($_SESSION['company']) && $_SESSION['company'] == 1 ? "../ven/account-company.php" : "account.php"; ?>"><i style="font-size:20px"
              class="fa"> &#xf013;</i></a> <?php } elseif ($_SESSION['status']==1) {?>

              <a href="../ven/admin/index.php"><i style="font-size:20px"class="fa">&#xf013;</i></a> <?php }
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Panier<span class="badge">0</span></a>
     ...
     <nav>
        <div id="mySidepanel" class="sidepanel">
           ...
           <section>
            ...
            <form method="post" action="<?php echo('../ven/index.php'); ?>">
            ...
            <div class="sign-nav">
                ...
                <button class="button-create" style="margin-top: 9px;" onclick="document.location.href='../ven/company-inscription.php'" >CRÉER UN COMPTE D'ENTREPRISE</button>
            </div>
            <?php endif; ?>
            <?php if (is_logged_in()) : ?>

              <p class="welcome"> Bienvenue <?php echo $_SESSION['full_name'] ; ?>
              <a class="log_out" href="<?php echo ('../ven/logout.php'); ?>">SE DECONNECTER</a>
    ...
    <section>
      <div class="sign-up" id="signup-container">
       ...
       <p class="rejoignez">Rejoignez-nous sur LoyaltyCard.fr</p>
            ...
            <form action="<?php echo('../ven/index.php'); ?>" method="post">
              ...
              <label for="entreprise_input" class="entreprise_input_">Entreprise<sup>*</sup></label>
              <input class="input-design-inscri" type="text" placeholder="" name="entreprise" id="entreprise_input" required value="<?php echo h($user['entreprise']); ?>">
